...
shinyUI(navbarPage("Macroeconomic Analysis with shiny",
                   tabPanel("Dashboard",
              ...
              <li>The entire tool is automated; the data is automatically refreshed every day (and stored in an RData file for faster loading) and the commentary is auto-generated.</li></ul>
              As the focus lies on automation, the econometric models are very simplistic, and the forecasts should not be taken too seriously.<p>
