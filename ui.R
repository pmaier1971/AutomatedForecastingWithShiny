                  ...
                  navbarPage("Economic Dashboard",
                             ...
                             navbarMenu("Detailed Analysis",           
                                        tabPanel("US Labor Market",
                                                 ...
                                                 h5("Work in progress. Charts show progress among different indicators during this recovery/expansion. The cycle is defined as starting in 2008;
                                                    cycle-trough is defined as the worst reading of the indicator during this cycle."),
